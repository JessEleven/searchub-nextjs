...
export default function MenuButton () {
  ...
  return (
    <>
      ...
      <div className={`${openMenu ? 'absolute md:hidden z-[1] ease-in transition duration-500 rounded-lg flex justify-center items-center left-5 right-5 top-5 h-56 dark:bg-opacity-90 dark:bg-slate-900 bg-[#E1E1E3] bg-opacity-90 shadow-lg dark:shadow-none' : 'hidden'}`
        }>
